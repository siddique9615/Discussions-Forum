<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMasterPage.master" AutoEventWireup="true" CodeFile="Addanswers.aspx.cs" Inherits="User_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        ...
        <tr>
            <td>Answer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
            <td class="auto-style1">
                <asp:TextBox ID="txtanswer" runat="server" TextMode="MultiLine" Width="660px"></asp:TextBox>
            </td>
        </tr>
    </table>
    <br />
    &nbsp;<asp:Button ID="btnaddanswers" class="btn btn-primary dropdown-toggle " runat="server" OnClick="btnadd_Click" Text="ADD Answers" BackColor="#009933" />
&nbsp;&nbsp;&nbsp;&nbsp;
    <br />
...
<asp:GridView class="table table-striped table-bordered table-hover" ID="gvmain" runat="server" AutoGenerateColumns="False" DataKeyNames="aid" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="gvmain_SelectedIndexChanged">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mycon %>" DeleteCommand="DELETE FROM [answers] WHERE [aid] = @aid" InsertCommand="INSERT INTO [answers] ([qid], [answer], [answeredby], [answeredon], [isactive]) VALUES (@qid, @answer, @answeredby, @answeredon, @isactive)" SelectCommand="SELECT * FROM [answers]" UpdateCommand="UPDATE [answers] SET [qid] = @qid, [answer] = @answer, [answeredby] = @answeredby, [answeredon] = @answeredon, [isactive] = @isactive WHERE [aid] = @aid">
        <DeleteParameters>
